CREATE DATABASE urban_sami_exp;
\connect urban_sami_exp;
...
CREATE INDEX IF NOT EXISTS raw_denue_establishments_country_idx
    ON raw.denue_establishments (country_code);

CREATE INDEX IF NOT EXISTS raw_denue_establishments_state_idx
    ON raw.denue_establishments (state_code);

CREATE INDEX IF NOT EXISTS raw_denue_establishments_city_idx
    ON raw.denue_establishments (city_code);

CREATE INDEX IF NOT EXISTS raw_denue_establishments_ageb_idx
    ON raw.denue_establishments (ageb_code);

CREATE INDEX IF NOT EXISTS raw_denue_establishments_manzana_idx
    ON raw.denue_establishments (manzana_code);

CREATE INDEX IF NOT EXISTS raw_denue_establishments_geom_gix
    ON raw.denue_establishments
    USING GIST (geom);
...
CREATE INDEX IF NOT EXISTS raw_population_units_level_idx
    ON raw.population_units (level);

CREATE INDEX IF NOT EXISTS raw_population_units_unit_idx
    ON raw.population_units (unit_code);

CREATE INDEX IF NOT EXISTS raw_population_units_city_idx
    ON raw.population_units (city_code);
...
CREATE INDEX IF NOT EXISTS raw_admin_units_level_idx
    ON raw.admin_units (level);

CREATE INDEX IF NOT EXISTS raw_admin_units_code_idx
    ON raw.admin_units (unit_code);

CREATE INDEX IF NOT EXISTS raw_admin_units_city_idx
    ON raw.admin_units (city_code);

CREATE INDEX IF NOT EXISTS raw_admin_units_geom_gix
    ON raw.admin_units
    USING GIST (geom);
